...
const TASKS = [{
  ...
  id: 16,
  emoji: '📅',
  description: 'Напишите условие которое будет находить две даты из списка консоль, <selection>03.06.2001</selection> и <selection>19.08.2007</selection>. Используя метод <selection>==</selection> — равно и логический оператор <selection>||</selection> — Или. Используйте конструкцию: <selection>console.log(date)</selection> чтобы вывести в консоль.',
  defaultCodeFunction: () => {
